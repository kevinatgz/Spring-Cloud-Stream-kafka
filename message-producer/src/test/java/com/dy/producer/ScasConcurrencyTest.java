...
public class ScasConcurrencyTest {
    ...
    public void test() throws InterruptedException {
        ...
        for (int i = 0; i < 59; i++) {
            ...
            packetUplinkProducer.publish(new Message(devEui, UUID.randomUUID().toString(),"3",i+""));
        }
    ...
    public static class PacketUplinkProducer {
        ...
        public void publish(Message model) {
    ...
    public static class PacketUplinkHandler {
        ...
        public void handle(Message model) throws InterruptedException {
            Thread.sleep(10);
